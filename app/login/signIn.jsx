  ...
  return (
    ...
    <div className='px-20 my-36 '> 
      <form onSubmit={signIn}>
        ...
        <h2 className='text-center text-4xl py-5 bg-gray-600 font-semibold  rounded-lg text-white'  >Sign In</h2>
        ...
        <input type="Password" className='py-3 rounded-lg px-5'  placeholder='enter Password'
         ...
         <button type='submit' className=' bg-gray-600 px-10 text-white font-semibold py-2 rounded-lg content-center' > <Link href="/home"> Login</Link></button>
         </div>
         
        
         <div className=' flex justify-center py-4 text-white font-semibold'>
